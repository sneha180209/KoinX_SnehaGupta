...
function FAQ() {
    const faqData = [
        ...
        },
        {
            ...
            answer: (
                <div>
                    <p>Here are the top 6 strategies for lowering your cryptocurrency taxes in Australia:
                </p>
                <br />

                        <li><b>Hold for over 12 months</b> - Hold your crypto for more than 12 months to qualify for a 50% long-term CGT discount to reduce your tax liability.</li><br />
                        <li><b>Offset gains with losses</b> - Offset capital gains with capital losses from cryptocurrency, reducing your overall tax burden.</li><br />
                        <li><b>Claim tax deductions</b>- Explore opportunities to claim significant deductions on your regular income if you're a trader or running a crypto business.</li><br />
                        <li><b>Use crypto tax tools</b> - Employ crypto tax software like KoinX or seek help from a crypto tax specialist to streamline calculations and ensure compliance.</li><br />
                        <li><b>Donate to charities</b> - Donate cryptocurrency to registered charities since it’s not a taxable event, and claim deductions on the donated amount.</li><br />
        ...
        },
        {
            ...
            answer: (
                <div>
                    <p>
                        In order to use a cryptocurrency tax calculator, you need to input information about your cryptocurrency transactions. After you enter your information, the cryptocurrency tax calculator will calculate the gain or loss on every transaction. This includes:
                    </p>
                    ...
                    <br />
                    <p>Still have doubts? <a className='text-bold' href="#">Consult with a crypto taxation expert</a></p>
                </div>
            )        
        },
        {
        ...
        answer: (
            <div>
                <p>
                To calculate your crypto tax in Australia accurately, you need to consider both income tax and capital gains tax. <br /><br />
                ...
                <b>Income Tax</b><br />
                In Australia, when an individual (investor) sells, trades, spends, earns (salary, mining, interest) or gifts cryptocurrency, the net capital gain is taxed at the same rate as their Income Tax. This tax rate is determined based on their total income for the tax year. <br /><br />

                <h2 className='font-bold text-xl'>Capital Gains Tax</h2><br />
                <p>Calculate your capital gains or losses on cryptocurrency transactions using this formula:<br /><b>Capital Gain/Loss = Capital Proceeds - Cost Basis </b><br /><br />

                <b>Note: 
                    Capital Proceeds (sale value or any form of receipt)
                    Cost Basis (costs incurred to acquire, hold, and dispose of the asset)</b> <br /><br />

                    Your tax rate depends on whether you held the cryptocurrency for more than 12 months (long-term) or less (short-term). Long-term gains receive a 50% discount. <br /><br />
    ...
    return (
        <div className='middle2'>
            <div className="w-full grid grid-cols-1 gap-4 mx-auto p-4">
                {/* FAQ section */}
                <div className="grid-cols-2">
                    <h2 className='font-bold text-2xl px-3 py-1'>Frequently Asked Questions</h2> <br />
                    <div className="text-gray-900 dark-text-white">
                        {faqData.map((faq, index) => (
                            <div key={index} className="mb-6 px-3 py-1">
